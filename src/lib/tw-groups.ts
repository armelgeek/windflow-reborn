...
const twgroups: TailwindGroup[] = [
    ...
    },
    {
        ...
        filter: ['grid', 'flex', 'menu', 'document'],
        components: [
    ...
    },
    {
        label: 'typography',
        components: [
            { name: 'Button', group: true, attr: 'italic', title: 'italic', icon: 'format_italic', css: 'float-left' },
            { name: 'Button', group: true, attr: 'underline', title: 'underline', icon: 'format_underline', css: 'float-left' },
            { name: 'Button', group: true, attr: 'line-through', title: 'strikethrough', icon: 'format_strikethrough', css: 'float-left' },
            { name: 'Button', group: true, attr: 'uppercase', title: 'uppercase', icon: 'arrow_upward', css: 'float-left' },
            { name: 'Button', group: true, attr: 'lowercase', title: 'lowercase', icon: 'arrow_downward', css: 'float-left' },
            { name: 'Button', group: true, attr: 'capitalize', title: 'capitalize', icon: 'text_fields', css: 'float-none' },
