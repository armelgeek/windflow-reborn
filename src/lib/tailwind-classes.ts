...
export const pixels = [1, 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 80, 96, 128, 160, 192, 224, 256];
...
export const colors = [
    'gray', 'bluegray', 'brown', 'red',
    'yellow', 'orange', 'green', 'lime',
    'teal', 'blue', 'indigo', 'purple', 'pink'
];

function setPercentages(prefix: string): string[] {
    const arr: string[] = [];
...
function setClass(prefix: string, negative = false): string[] {
    const arr: string[] = [];

    if (negative) {
        const neg = [...pixels].reverse();
        neg.forEach(v => {
            arr.push(`-${prefix}-${Math.floor(v/4)}`);
        });
        arr.push(' ');
    }
...
function setOpacity(prefix: string): string[] {
    const arr: string[] = [];
    for (let n = 0; n < 5; n++) {
...
function setColors(prefix: string): string[] {
    const arr: string[] = ['transparent', 'white', 'black'];
...
export const classes = {
    ...
    semantics: [
        ...
        'footer', 'form', 'header', 'hero', 'label', 'main',
        'mark', 'nav', 'product', 'section', 'span', 'summary', 'time'
    ],
    textSize: [
        'text-xs', 'text-sm', 'text-base', 'text-lg', 'text-xl',
        'text-2xl', 'text-3xl', 'text-4xl', 'text-5xl', 'text-6xl',
        'text-7xl', 'text-8xl', 'text-9xl', 'text-10xl', 'text-20xl'
    ],
    textAlign: [
    ...
    zindex: [
        'z-auto', 'z-0', 'z-1', 'z-2', 'z-3', 'z-4', 'z-5',
        'z-6', 'z-7', 'z-8', 'z-9', 'z-10', 'z-20', 'z-30',
        'z-40', 'z-50', 'z-max', 'z-top', 'z-2xtop'
    ],
    gridcols: [
    ...
    colspan: [
        'md:col-span-auto', 'md:col-span-1', 'md:col-span-2', 'md:col-span-3',
        'md:col-span-4', 'md:col-span-5', 'md:col-span-6', 'md:col-span-7',
        'md:col-span-8', 'md:col-span-9', 'md:col-span-10', 'md:col-span-11',
        'md:col-span-12', 'md:col-span-full'
    ],
    gridgap: [
        'gap-1', 'gap-2', 'gap-3', 'gap-4', 'gap-5', 'gap-6', 'gap-8',
        'gap-10', 'gap-12', 'gap-16', 'gap-20', 'gap-24', 'gap-32',
        'gap-40', 'gap-48', 'gap-56', 'gap-64'
    ],
    alignitems: [
    ...
    justifyitems: [
        'justify-items-auto', 'justify-items-start', 'justify-items-center',
        'justify-items-end', 'justify-items-stretch'
    ],
    justifyself: [
        'justify-self-auto', 'justify-self-start', 'justify-self-center',
    ...
    borderTop: [
        'border-t', 'border-t-2', 'border-t-4', 'border-t-8'
    ],
    borderLeft: [
        'border-l', 'border-l-2', 'border-l-4', 'border-l-8'
    ],
    borderRight: [
        'border-r', 'border-r-2', 'border-r-4', 'border-r-8'
    ],
    borderBottom: [
        'border-b', 'border-b-2', 'border-b-4', 'border-b-8'
    ],
    ...
    spacing: setPercentages('p'),
    spacingTop: setPercentages('pt'),
    spacingBottom: setPercentages('pb'),
    spacingLeft: setPercentages('pl'),
    spacingRight: setPercentages('pr'),
    ...
    positionelement: [
        'static', 'fixed', 'absolute', 'relative', 'sticky', 'modal'
    ],
    positionTop: ['top-0'],
    positionLeft: ['left-0'],
    ...
    rotate: [
        ...
        'rotate-45', 'rotate-90', 'rotate-180', '-rotate-0', '-rotate-1', '-rotate-2',
        '-rotate-3', '-rotate-6', '-rotate-12', '-rotate-45', '-rotate-90', '-rotate-180'
    ],
    skewX: [
    ...
    rotate3D: [
        'perspective-rotate3dX', 'perspective-rotate3dX-inverse',
        'perspective-rotate3dY', 'perspective-rotate3dY-inverse'
    ],
    rounded: [
    ...
    grayscale: ['grayscale'],
    animation: [
        'animate-none', 'animate-ping', 'animate-bounce',
        'animate-spin', 'animate-pulse', 'animate-slidein', 'animate-slideout'
    ],
    clipPath: [
